...
function CreateAccount() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex flex-col md:flex-row w-3/4 md:w-1/2 min-h-[500px] rounded-md shadow-2xl">
        ...
        <div className="w-full md:w-2/3 pl-4 pr-4 flex flex-col h-full">
          ...
          {otpSend && (
            <OtpVerification
              email={email}
              resend={resend}
              path="opt-verification-register"
              msg="SignUp"
            />
          )}
          {!otpSend && (
          ...
          {!otpSend && (
            <Link to="/login">
              <button className="rounded-sm w-full p-4 text-blue-600 mb-8 font-semibold shadow-2xl">
